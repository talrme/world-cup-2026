window.WORLD_CUP_AI_INSIGHTS = {
  "generatedAt": "2026-07-05T11:47:40+00:00",
  "matches": {
    "12": {
    ...
    "6": {
      ...
      "summary": "Brazil and Morocco battled to a 1-1 draw in their opening Group C match, setting the tone for a competitive group stage.",
      "story": [
        "The opening match for both nations ended in a 1-1 stalemate, a result that forced both teams to fight for their positioning throughout the remainder of the group stage. Neither side could find a decisive edge, leaving them to split the points in a tense start to their tournament campaigns.",
        "Following this result, both teams showed resilience in their subsequent matches. Brazil went on to secure victories over Haiti and Scotland, while Morocco bounced back with wins against Scotland and Haiti to secure their own path into the knockout bracket.",
        "The competitive nature of this draw was a precursor to successful runs for both squads. Brazil advanced to the Round of 16 to face Norway, while Morocco navigated their way through the Round of 32 and Round of 16 to reach a quarterfinal showdown against France."
      ],
      "bullets": [
        "The 1-1 draw was the only match in Group C that did not result in a win for either Brazil or Morocco.",
        "Brazil and Morocco finished the group stage level on 7 points, with Brazil claiming first place due to a superior goal difference of +6 compared to Morocco's +3.",
        "Both teams successfully advanced through the knockout rounds following this initial meeting."
      ],
      "sections": [],
      "updatedAt": "2026-07-05T05:19:01+00:00",
