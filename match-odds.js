window.WORLD_CUP_MATCH_ODDS = {
  "generatedAt": "2026-07-10T16:00:52+00:00",
  "source": {
    "label": "ESPN odds",
  ...
  "matches": {
    "98": {
      ...
      "asOf": "2026-07-10T16:00:52+00:00",
      "espnEventId": "760511",
      "outcomes": [
        {
          "key": "home",
          "label": "Spain",
          "american": -165,
          "rawProbability": 0.6226415094339622,
          "advanceProbability": 0.7816683831101957
        },
        {
          "key": "away",
          "label": "Belgium",
          ...
          "advanceProbability": 0.21833161688980432
        }
      ],
      "draw": {
      ...
      "rawTeamTotal": 0.7965545529122231,
      "rawMarketTotal": 1.0529648093224795
    },
    "99": {
      "market": "Chance to advance",
      "calculation": "Derived from ESPN-listed team moneylines; the draw path is allocated proportionally to the two teams.",
      ...
      "outcomes": [
        {
          ...
          "american": 300,
          "rawProbability": 0.25,
          "advanceProbability": 0.32307692307692304
        },
        {
          "key": "away",
          "label": "England",
          ...
          "advanceProbability": 0.676923076923077
        }
      ],
      "draw": {
        "label": "Draw after 90 minutes",
      ...
      "rawTeamTotal": 0.7738095238095238,
      "rawMarketTotal": 1.04778212654925
    },
    "100": {
      "market": "Chance to advance",
      "calculation": "Derived from ESPN-listed team moneylines; the draw path is allocated proportionally to the two teams.",
